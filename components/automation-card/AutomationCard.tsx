...
export default function AutomationCard({
  ...
  return (
    <div className="group relative bg-gray-900/50 rounded-xl shadow-sm border border-red-900/30 hover:shadow-lg transition-all duration-300 overflow-hidden">
      ...
      <div className="absolute top-0 left-0 right-0 h-1 bg-linear-to-r from-black via-red-950 to-red-900"></div>

      <div className="p-6">
        <div className="flex items-start justify-between mb-4">
          <div className="flex items-center gap-3">
            <div className="flex items-center justify-center w-12 h-12 bg-linear-to-br from-black to-red-950 rounded-lg group-hover:scale-110 transition-transform duration-300">
              {icon}
            </div>
            <div>
        ...
        <button
          ...
          className={`w-full mt-4 px-4 py-2.5 rounded-lg font-medium transition-all duration-200 transform shadow-sm hover:shadow-md flex items-center justify-center gap-2 ${
            isExecuting
              ...
              : "bg-linear-to-r from-black to-red-950 text-white hover:from-gray-900 hover:to-red-900 hover:scale-[1.02] active:scale-[0.98]"
          }`}
        >
          {isExecuting ? (
            <>
